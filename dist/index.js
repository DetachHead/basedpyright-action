...
var pyrightToolName = "basedpyright";
...
async function getPyrightInfo() {
  ...
  const url = `https://registry.npmjs.org/${pyrightToolName}/${version3}`;
  ...
  if (fs.existsSync(configPath)) {
    ...
    while (cwd !== root) {
      ...
      if (fs.existsSync(pyprojectPath)) {
        const toolSection = TOML.parse(fs.readFileSync(pyprojectPath, "utf8"))["tool"];
